...
describe('Library', function () {
  ...
  it('should console log book title and author', function() {
    const books = [
      new Book('JK Rowling', 'Harry Potter', 'Fantasy'),
    ];
    library.addBooks(books);
    library.printInventory()
    // assert.strictEqual("Harry Potter by JK Rowling", library.printInventory());
  })
});
